...
#define MBED_CONF_APP_DEBUG_MSG                                               0                                                                                                // set by application
#define MBED_CONF_APP_SD_CLK                                                  D13                                                                                              // set by application
#define MBED_CONF_APP_SD_CS                                                   D10                                                                                              // set by application
#define MBED_CONF_APP_SD_MISO                                                 D12                                                                                              // set by application
#define MBED_CONF_APP_SD_MOSI                                                 D11                                                                                              // set by application
